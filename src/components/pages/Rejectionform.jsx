...
alert("hii");
  ...
  {
    const response = axios.post('http://localhost:8000/api/add_schedule', valuesrejection);
  ...
  return { handleChange,valuesrejection,handleSubmitrejection,errorsrejection};
}
