...
<div  className="main-content-section">
    ...
    <div class="col-md-12 card-head-bg">
    ...
    <div class=" col-md-12">
        <article class="in-progress-card">
            <div class="in-progress-card-post">
                <button className="in-progress-card--bt-top">JAVA DEVELOPER</button>
            </div>
            <div class="in-progress-card-box-txt ">
                <div class="in-progress-name-sty">
                     Arun Kumar
                 </div>
                 <div class="in-progress-eye-icon ">
                <a href=""> <img src={eyeico}/></a>
                 </div>
            </div>
            <div class="in-progress-card-box-txt ">
                <div class="in-progress-name-sty-fullw">
            ...
            <div class="in-progress-card-box-txt ">
                 ...
                 <div class="in-progress-name-thre-colm p-l-0 ">
                 EXP:  4.6Yrs
                 </div>
                 <div class="in-progress-name-thre-colm ">
                 CTC:  5LK/A
                 </div>
                 <div class="in-progress-name-thre-colm b-r-0 ">
                 EXP CTC: 5LK/A
                 </div>
            </div>
            <div class="in-progress-card-box-txt b-b-0">
                <div class="in-progress-location">
  ...
  <article class="card">
    ...
    <div class="col-md-12 card-head-bg">
      ...
      <div class="pull-right"><button className="card-header-bt-rigt-Schdl">40 Items</button></div>
    </div>
    <div class=" col-md-12">
        <article class="in-progress-card-Schdl">
            <div class="in-progress-card-post">
  ...
  <article class="card">
    ...
    <div class="col-md-12 card-head-bg">
      ...
      <div class="pull-right"><button className="card-header-bt-rigt-reject">40 Items</button></div>
    </div>
    <div class=" col-md-12">
        <article class="in-progress-card-reject">
            <div class="in-progress-card-post">
  ...
  <article class="card">
    ...
    <div class="col-md-12 card-head-bg">
      ...
      <div class="pull-right"><button className="card-header-bt-rigt-waiting">40 Items</button></div>
    </div>
    <div class=" col-md-12">
        <article class="in-progress-card-waiting">
            <div class="in-progress-card-post">
